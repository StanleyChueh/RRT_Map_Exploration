...
def check_collision(x1, y1, x2, y2, stepSize):
...
def RRT(img, img2, start, end, stepSize):
    ...
    while not pathFound:
        ...
        # check direct connection
        tx, ty, directCon, nodeCon = check_collision(nx, ny, nearest_x, nearest_y, stepSize)
...
def main(args=None):
    ...
    global img, img2, node_list, coordinates, end
